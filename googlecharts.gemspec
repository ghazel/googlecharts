Gem::Specification.new do |s|
  ...
  s.files = %w(History.txt License.txt Manifest.txt README.txt Rakefile config/hoe.rb config/requirements.rb lib/gchart.rb lib/gchart/aliases.rb lib/gchart/theme.rb lib/themes.yml lib/gchart/version.rb setup.rb spec/gchart_spec.rb spec/spec.opts spec/spec_helper.rb spec/fixtures/test_theme.yml tasks/environment.rake tasks/rspec.rake)
  s.has_rdoc = true
